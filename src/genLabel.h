...
void generateFixedListMatchingCode(Rule *rule, RuleLabel label, int indent, string f_prefix);

/* Generates code to match a rule list containing a list variable to a host graph list. */
void generateVariableListMatchingCode(Rule *rule, RuleLabel label, int indent, string f_prefix);

/* Generates code to evaluate predicates containing the given variable. */
void generateVariableResultCode(Rule *rule, int id, bool list_variable, int indent, string f_prefix);
...
void generateLabelEvaluationCode(RuleLabel label, bool node, int count, int predicate, int indent, string f_prefix);
