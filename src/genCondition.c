...
void generateConditionVariables(Condition *condition, string f_prefix)
{
   ...
   switch(condition->type)
   {
      ...
      case 'a':
      case 'o':
           generateConditionVariables(condition->left_condition, f_prefix);
           generateConditionVariables(condition->right_condition, f_prefix);
           break;
...
void generateConditionEvaluator(Condition *condition, bool nested, string f_prefix)
{
   ...
   switch(condition->type)
   {
      ...
      case 'a':
           if(nested) PTF("(");
           generateConditionEvaluator(condition->left_condition, true, f_prefix);
           PTF(" && ");
           generateConditionEvaluator(condition->right_condition, true, f_prefix);
           if(nested) PTF(")");
           break;
